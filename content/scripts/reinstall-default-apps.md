---
title: "Reinstall Default Apps"
date: 2026-08-15T13:51:37-05:00
author: "Jason, Cyber Professional"
section: "scripts"
tags: ["powershell", "troubleshooting", "appx", "windows-apps"]
description: "Re-registers all default Windows 10/11 apps to fix a broken Start Menu, crashing Settings app, or other misbehaving built-in Windows features — without a full OS reinstall."
github: "https://github.com/thestrad031487/cybergrind-scripts/blob/main/Troubleshooting/Reinstall-DefaultApps.ps1"
---
...
Some package failures during the run are common and often benign — a resource in use, or a system package that isn't meant to re-register this way. Don't be alarmed by warnings in the console; check the log if issues persist after restarting. A restart is recommended once the script completes.

### References

- [View on GitHub](https://github.com/thestrad031487/cybergrind-scripts/blob/main/Troubleshooting/Reinstall-DefaultApps.ps1)
