---
title: "Set Power Settings Best Performance"
date: 2026-08-15T23:24:57-05:00
author: "Jason, Cyber Professional"
section: "scripts"
tags: ["powershell", "troubleshooting", "power-management", "windows-11"]
description: "Sets Windows 11 sleep and display timeouts to Never and switches the Power Mode slider to Best Performance — useful for workstations, kiosks, or troubleshooting where you don't want the machine sleeping or throttling."
github: "https://github.com/thestrad031487/cybergrind-scripts/blob/main/Troubleshooting/Set-PowerSettings-BestPerformance.ps1"
---

## What it does

Sets Windows 11 display, sleep, and hibernate timeouts to Never (both on AC power and battery), and switches the Power Mode slider to Best Performance. Useful for workstations, kiosks, or troubleshooting scenarios where you don't want the machine sleeping, dimming, or throttling. Logs every change and verifies the settings actually applied before finishing.

## Requirements

- Windows 11 for the Power Mode change (the Never timeout settings also work on Windows 10)
...
The Power Mode overlay (Best Performance / Balanced / Best Power Efficiency) is a Windows 11-only feature. On Windows 10 this step will fail harmlessly and log a warning — the sleep/display timeout changes will still apply normally.

### References

- [View on GitHub](https://github.com/thestrad031487/cybergrind-scripts/blob/main/Troubleshooting/Set-PowerSettings-BestPerformance.ps1)
